 ...
 class Calculator{
    ...
    delete(){
        this.currentOperand = this.currentOperand.toString().slice(0,-1) ///texte girilmiş sayıları tektek silmke için 
   ...
   compute(){ //hesabın yapıldıgı fonksiyon
    let computation
   ...
   updateDisplay() //hesap makinesinde gösterilecek olan sonu için 
   {
    this.currentOperandTextElement.innerText = this.currentOperand //siyah ekranın  testini bununla sayı ile  güncelle
